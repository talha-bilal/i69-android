...
class InterestListAdapter(private val listener: InterestListener) :
    RecyclerView.Adapter<InterestListAdapter.ViewHolder>() {

    private val list: ArrayList<String> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(
        ListItemInterestBinding.inflate(
    ...
    inner class ViewHolder(val viewBinding: ListItemInterestBinding) :
