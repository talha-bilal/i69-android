...
class BlockUsersListAdapter(private val listener: BlockListener) :
    RecyclerView.Adapter<BlockUsersListAdapter.ViewHolder>() {

    private val list: ArrayList<BlockedUser> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(
        ItemBlockedUserBinding.inflate(
    ...
    inner class ViewHolder(val viewBinding: ItemBlockedUserBinding) :
